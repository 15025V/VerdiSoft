...
export default function FormSection() {
  ...
  return (
    <section className="flex justify-center items-center min-h-screen px-4 py-8 sm:px-6 sm:py-10 font-serif relative">
      {/* Fondo de cilantro para móviles */}
      <div className="md:hidden absolute inset-0 z-0 overflow-hidden opacity-100">
        <img
          src="/cill.png"
      ...
      <div className="relative w-full max-w-5xl flex flex-col md:flex-row rounded-tl-[40px] md:rounded-tl-[80px] rounded-br-[40px] md:rounded-br-[80px] shadow-lg md:shadow-2xl overflow-hidden z-10">
        {/* Imagen de cilantro para desktop */}
        <img
          src="/cill.png"
          alt="Hoja de cilantro"
