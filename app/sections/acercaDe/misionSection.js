...
export default function MisionSection() {
  ...
  return (
    <section
      id="mission"
      className="w-screen overflow-hidden px-6 py-14 md:px-20 lg:px-36 flex flex-col items-center text-center"
    >
      <h2
      ...
      <div className="grid md:grid-cols-3 gap-8 mt-10">
        ...
        <div className="bg-white shadow-lg rounded-2xl overflow-hidden flex h-full">
          <CldImage
            src="galeria_6_pacikz" // Reemplaza con el publicId de tu imagen
