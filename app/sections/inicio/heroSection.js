...
export default function HeroSection() {
  ...
  return (
    <>
      <Head>
        <title>Flores Sons Farms - Exportación de Cilantro Fresco</title>
        <meta
          name="description"
          content="Flores Sons Farms se especializa en la exportación de cilantro fresco y de alta calidad, directo del campo a tu mercado."
        />
      </Head>
      ...
      <section className="relative w-full h-screen flex items-center justify-center">
        ...
        <div className="absolute inset-0 z-0">
          <CldImage
            ...
            alt="Cilantro fresco en campo de cultivo"
            fill
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full h-full flex flex-col">
          <div className="flex-grow flex flex-col md:flex-row items-center justify-center gap-12">
            ...
            >
              <h1 className="text-5xl font-bold text-white italic mb-4 leading-tight font-serif">
                Flores Sons Farms
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                ...
                >
                  {translations.hero?.boton || 'Contáctanos'}
                </a>
                ...
                >
                  {translations.hero?.boton1 || 'Conoce más'}
                  <FaSeedling className="text-3xl animate-bounce" />
                </a>
              </div>
            </motion.div>
            ...
            >
              <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 transition-transform duration-300">
                <CldImage
                  src="galeria_2_dfb2nj"
                  alt="Cilantro empacado listo para exportación"
                  fill
          ...
          <div className="sticky bottom-8 left-0 right-0 flex justify-center gap-3 sm:gap-5 text-white text-xl sm:text-2xl w-full z-20 py-2">
            {[
              { icon: <FaFacebook />, url: 'https://www.facebook.com/profile.php?id=61575979664383', label: 'Facebook' },
