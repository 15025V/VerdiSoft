...
export default function UbicationSection() {
  ...
  return (
    <div role="region" aria-labelledby="ubicacion-heading">
      <section className="py-16 md:py-24 bg-gradient-to-br  to-gray-200 text-center"> 
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row gap-10 md:gap-12 items-center max-w-7xl mx-auto">
            ...
            <div className="w-full md:w-1/2 text-left">
              <div className="p-6 md:p-14 rounded-xl shadow-2xl border border-gray-400 bg-white"> 
                ...
                <div className="mb-6 md:mb-8 text-base md:text-lg leading-relaxed font-serif text-gray-700">
                  <p className="mb-3 md:mb-4">{translations.ubicacion?.direccion}</p>
                  <p className="mb-3 md:mb-4">{translations.ubicacion?.telefono}</p>
                  <p className="mb-3 md:mb-4">{translations.ubicacion?.correo}</p>
                </div>
                <a
                  href="/contact"
